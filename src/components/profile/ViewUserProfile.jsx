...
const ViewProfile = (props) => {
    ...
    const addAddress = async () => {
        ...
        if (response.status === 200) {
            successDarkTopCenter('New Address Added')
            setTimeout(() => {navigate("/profile")}, 5000)
        } else {
            errorDarkTopCenter('Failed to add new Address')
        }
    }
                ...
                <div className="row">
                    <div className="col-md-3 border-right">
                        <div className="d-flex flex-column align-items-center text-center p-3 py-5">
                            <img className="rounded-circle mt-5" width="175px" height="200px" src={props.userProfileDetails.profilePicture} alt="Profile "/>
